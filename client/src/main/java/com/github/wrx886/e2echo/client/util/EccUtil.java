...
public class EccUtil {
    ...
    public static KeyPairHex generateKeyPair() {
        try {
            ...
            e.printStackTrace();
            throw new E2Echoxception(null, "密钥对生成失败");
        }
    }
     ...
     */
    public static String encrypt(String plainText, String hexPublicKey) {
        PublicKey publicKey;
        try {
            publicKey = rawHexToPublicKey(hexPublicKey);
        } catch (Exception e) {
            e.printStackTrace();
            throw new E2Echoxception(CodeEnum.ECC_PUBLIC_KEY_FORMAT_ERROR);
        }
        try {
            if (plainText == null) {
                return null;
     ...
     */
    public static String decrypt(String encryptedHex, String hexPrivateKey) {
        PrivateKey privateKey;
        try {
            privateKey = rawHexToPrivateKey(hexPrivateKey);
        } catch (Exception e) {
            e.printStackTrace();
            throw new E2Echoxception(CodeEnum.ECC_PRIVATE_KEY_FORMAT_ERROR);
        }
        try {
     ...
     */
    public static String sign(String data, String hexPrivateKey) {
        PrivateKey privateKey;
        try {
            privateKey = rawHexToPrivateKey(hexPrivateKey);
        } catch (Exception e) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new E2Echoxception(null, "签名失败");
        }
    }
     ...
     */
    public static boolean verify(String data, String signatureHex, String hexPublicKey) {
        PublicKey publicKey;
        try {
            publicKey = rawHexToPublicKey(hexPublicKey);
        } catch (Exception e) {
