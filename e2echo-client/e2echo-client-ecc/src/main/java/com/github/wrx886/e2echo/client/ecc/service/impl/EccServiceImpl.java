package com.github.wrx886.e2echo.client.ecc.service.impl;
...
import com.github.wrx886.e2echo.client.ecc.util.EccUtil;
...
@Service
@AllArgsConstructor
public final class EccServiceImpl implements EccService {
    ...
    public KeyPairHex generateKeyPair() {
        try {
            ...
            throw new E2EchoException(E2EchoExceptionCodeEnum.ECC_KEY_PAIR_GENERATION_FAILED);
        }
    }
    ...
    public void login(String publicKeyHex, String privateKeyHex) {
        try {
            ...
            if (!plain.equals(decrypted)) {
                // 公私钥不匹配
                throw new E2EchoException(E2EchoExceptionCodeEnum.ECC_KEY_PAIR_INVALID);
            }
    ...
    public EccMessage encrypt(EccMessage eccMessage) {
        ...
        if (eccMessage.getToPublicKeyHex() == null || eccMessage.getToPublicKeyHex().isBlank()) {
            throw new E2EchoException(E2EchoExceptionCodeEnum.ECC_PUBLIC_KEY_IS_EMPTY);
        }
        ...
        if (eccMessage.getData() == null) {
            throw new E2EchoException(E2EchoExceptionCodeEnum.ECC_DATA_IS_NULL);
        }
        ...
        try {
            ...
            throw new E2EchoException(E2EchoExceptionCodeEnum.ECC_ENCRYPT_FAILED);
        }
    ...
    public EccMessage decrypt(EccMessage eccMessage) {
        ...
        try {
            if (!EccUtil.verify(
                ...
                throw new E2EchoException(E2EchoExceptionCodeEnum.ECC_SIGNATURE_NOT_MATCH);
            }
        } catch (E2EchoException e) {
            throw e;
        } catch (Exception e) {
            throw new E2EchoException(E2EchoExceptionCodeEnum.ECC_SIGNATURE_VERIFY_FAILED);
        }
     ...
     * @return Map
     */
    private LinkedHashMap<String, String> toMap(EccMessage eccMessage) {
