package com.github.wrx886.e2echo.server.web.wocket.request;
...
public class WebSocketResult<E> {
    ...
    public static <E> WebSocketResult<E> ok(String id, String command, E data) {
        return build(id, command, data, ResultCodeEnum.OK);
    }
    ...
    public static <E> WebSocketResult<E> fail(String id, String command, E data) {
        return build(id, command, data, ResultCodeEnum.FAIL);
    }
    ...
    public static <E> WebSocketResult<E> build(String id, String command, E data, ResultCodeEnum resultCodeEnum) {
    ...
    public static WebSocketResult<Void> build(String id, String command, ResultCodeEnum resultCodeEnum) {
        return build(id, command, null, resultCodeEnum);
    }
}
